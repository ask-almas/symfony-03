...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\LikeNotificationRepository' => function () {
    return ($this->privates['App\Repository\LikeNotificationRepository'] ?? $this->load('getLikeNotificationRepositoryService.php'));
}, 'App\\Repository\\MicroPostRepository' => function () {
    return ($this->privates['App\Repository\MicroPostRepository'] ?? $this->load('getMicroPostRepositoryService.php'));
...
}, 'App\\Repository\\UserPreferencesRepository' => function () {
    return ($this->privates['App\Repository\UserPreferencesRepository'] ?? $this->load('getUserPreferencesRepositoryService.php'));
