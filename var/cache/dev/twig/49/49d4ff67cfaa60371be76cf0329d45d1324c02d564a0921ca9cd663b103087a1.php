...
class __TwigTemplate_01ae6461ce2dab70d880393e087b66771b939251945ffa1eb585d523fa7780e0 extends Twig_Template
{
    private $source;
    ...
    <form action=\"";
        ...
        // line 25
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new Twig_Error_Runtime('Variable "app" does not exist.', 25, $this->source); })()), "request", array()), "get", array(0 => "redirect_to"), "method"), "html", null, true);
        echo "\">
        </div>
    </form>
";
    ...
    {
        return array (  92 => 25,  88 => 24,  76 => 15,  68 => 10,  65 => 9,  59 => 6,  56 => 5,  53 => 4,  44 => 3,  15 => 1,);
    }
...
{% endblock %}", "security/login.html.twig", "/home/almas/Downloads/Projects/Udemy/Symfony/symfony-02/templates/security/login.html.twig");
    }
}
