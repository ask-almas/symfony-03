...
class MicroPost extends \App\Entity\MicroPost implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\MicroPost' . "\0" . 'id', '' . "\0" . 'App\\Entity\\MicroPost' . "\0" . 'user', '' . "\0" . 'App\\Entity\\MicroPost' . "\0" . 'time', '' . "\0" . 'App\\Entity\\MicroPost' . "\0" . 'text', '' . "\0" . 'App\\Entity\\MicroPost' . "\0" . 'likedBy'];
        }
