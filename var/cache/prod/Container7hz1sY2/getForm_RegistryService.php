...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\MicroPostType' => function () {
    return ($this->privates['App\Form\MicroPostType'] ?? $this->privates['App\Form\MicroPostType'] = new \App\Form\MicroPostType());
